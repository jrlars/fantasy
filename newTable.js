...
connection.query('CREATE TABLE ' + tableName + '(playerName varchar(255) NOT NULL, playerID int NOT NULL, position varchar(255) NOT NULL, year int NOT NULL, week int NOT NULL, team varchar(255) NOT NULL, opponent varchar(255) NOT NULL, homeAway varchar(255) NOT NULL, completions int, attempts int, passingYards int, passingTouchdowns int, interceptions int, rushes int, rushingYards int, rushingTouchdowns int, receptions int, receivingYards int, receivingTouchdowns int, targets int, twopc int, fumbles int, miscTouchdown int, standardPoints float(1), halfPprPoints float(1), pprPoints float(1), PRIMARY KEY (playerID, year, week));',function(err,rows){
  if(err) throw err;
